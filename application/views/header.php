...
<!-- <body oncontextmenu="return true;" class="skin-red-light sidebar-mini sidebar-collapse" style="height: auto;"> -->
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url('stok')?>"><i class="fa fa-circle-o"></i>Stok Barang</a></li>
            <!-- <li><a href="<?php echo base_url('sales')?>"><i class="fa fa-circle-o"></i>Sales</a></li> -->
            <li><a href="<?php echo base_url('skema_kredit')?>"><i class="fa fa-circle-o"></i>Skema Kredit</a></li>
            <li><a href="<?php echo base_url('provinsi')?>"><i class="fa fa-circle-o"></i>Provinsi</a></li>
            <li><a href="<?php echo base_url('kabupaten')?>"><i class="fa fa-circle-o"></i>Kabupaten</a></li>
            <li><a href="<?php echo base_url('ekspedisi')?>"><i class="fa fa-circle-o"></i>Ekspedisi</a></li>
            <li><a href="<?php echo base_url('layanan')?>"><i class="fa fa-circle-o"></i>Layanan</a></li>
            <li><a href="<?php echo base_url('ongkir')?>"><i class="fa fa-circle-o"></i>Ongkir</a></li>
            <li><a href="<?php echo base_url('tentang')?>"><i class="fa fa-circle-o"></i>Tentang Kami</a></li>
            <!-- <li><a href="<?php echo base_url('manajemen_sopir')?>"><i class="fa fa-circle-o"></i>Manajemen Sopir</a></li> -->
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
        <?php $total= "SELECT * FROM prospek WHERE status ='baru'";?>
          <?php $bb = $this->db->query($total);?>
        <li class="treeview">
          <a href="<?php echo base_url('prospek')?>">
            <i class="fa fa-bar-chart"></i>
            <span>Pengajuan Kredit</span>
             <span class="badge bg-red">
                <?php echo $bb->num_rows()?>
            </span>
          </a>
        </li>
            <li><a href="<?php echo base_url('pembayaran')?>"><i class="fa fa-money"></i>Proses Pesanan Kredit</a></li>
            <li><a href="<?php echo base_url('sales_order')?>"><i class="fa fa-money"></i>Konfirmasi Pesanan Kredit</a></li>
            <li><a href="<?php echo base_url('tagihan_konsumen')?>"><i class="fa fa-money"></i>Tagihan Konsumen</a></li>
            
            <?php $total2= "SELECT * FROM pembelian WHERE status ='baru'";?>
          <?php $bb2 = $this->db->query($total2);?>
        <li class="treeview">
          <a href="<?php echo base_url('pembelian')?>">
            <i class="fa fa-bar-chart"></i>
            <span>Pembelian Cash</span>
             <span class="badge bg-red">
                <?php echo $bb2->num_rows()?>
            </span>
          </a>
        </li>
          </ul>
