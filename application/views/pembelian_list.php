...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
      ...
      <?php $prov=$this->db->query("select * from provinsi where id='$pembelian->provinsi'")->row_array();?>
      <?php $lay=$this->db->query("select * from ekspedisi where id='$pembelian->ekspedisi'")->row_array();?>
			<td><?php echo $prov['provinsi'] ?></td>
			<!-- <td><?php echo $prov['kecamatan'] ?></td> -->
